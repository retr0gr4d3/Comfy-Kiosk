...
import { raiseBodyOverlays } from '../popups/bodyOverlays'
...
export function ensurePanelView(
  ...
  // An overlay open over the body (terminal, apps) must stay above the new panel.
  raiseBodyOverlays(entry.window)
